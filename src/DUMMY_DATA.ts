import { CategoryType, PostType } from "@/types/database";
...
export const DUMMY_POSTS: PostType[] = [
  ...
  {
    id: "7",
    title: "The wonderfull of Padar Island",
    description:
      "Do you agree that we call Indonesia “country of treasures”? Among them are Labuan Bajo and the neighboring archipelago known as Komodo National Park in East Nusa Tenggara, which have been globally popular.",
    category: { id: "1", title: "Cities" },
    author: { id: "1", first_name: "Erlan", last_name: "Erlangga" },
    slug: "the-wonderfull-of-padar-island",
    image:
      "https://images.unsplash.com/photo-1571880826835-7ab2b833ad07?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    body: "Speaking of nature, exotism and satisfaction, this island offers them all. Although you need a little bit of effort on the journey, the end result would be so much worth it. You wouldn’t regret the breathtaking view when you first arrive. As mentioned earlier, hiking to the peak of the hill lets you find out why it is called exotic.",
    date_created: "2023-03-02T00:00:00.000Z",
    date_updated: "2023-03-02T00:00:00.000Z",
  },
];
